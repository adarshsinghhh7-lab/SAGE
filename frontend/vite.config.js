 ...
 *
 * The frontend lives in `frontend/` (sibling of `backend/`), and the backend is
 * spawned with the repo root as its working directory.
 */
const repoRoot = path.resolve(__dirname, '..');

function ensureSageBackendRunning() {
  return {
