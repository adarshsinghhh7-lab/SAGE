...
export const NotFoundPage = ({ onNavigate, message = 'The page you are looking for does not exist in the S.A.G.E. ledger.', }) => {
    return (<div className="max-w-3xl mx-auto py-16 sm:py-24 px-4">
