 ...
 */
export const SageLogo = ({ size = 40, withWordmark = false, className = '', title = 'S.A.G.E. — Anonymous Grievance & Escalation Ledger', }) => (<span className={`inline-flex items-center ${withWordmark ? 'gap-2.5' : ''} ${className}`} role="img" aria-label={title}>
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="shrink-0">
      ...
      {/* Sage leaf */}
      <path d="M32 19C40 22.5 43 28.5 43 34.5C43 40 38.5 44 32 45C25.5 44 21 40 21 34.5C21 28.5 24 22.5 32 19Z" fill="#F6F3EB"/>
      {/* Central leaf vein */}
    ...
    {withWordmark && (<span className="flex flex-col text-left">
        <span className="text-[1.5rem] leading-none font-semibold tracking-tight text-ink" style={{ fontFamily: "'Fraunces', Georgia, serif" }}>
          S.A.G.E.
        </span>
