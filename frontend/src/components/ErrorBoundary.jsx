...
export class ErrorBoundary extends Component {
    ...
    render() {
        if (this.state.hasError) {
            ...
            return (<div className="min-h-screen flex items-center justify-center bg-canvas px-4">
          <div className="max-w-2xl w-full bg-surface border border-line-strong p-8 sm:p-12 text-center paper-grain rounded-2xl shadow-lift">
            ...
            {this.state.error && (<details className="mb-6 text-left bg-ink border border-line-strong p-4 rounded-xl">
