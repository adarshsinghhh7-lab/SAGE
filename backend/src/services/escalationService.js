 ...
 */
export async function runAutoEscalation(options = {}) {
 ...
 */
export function startHourlyEscalationScheduler() {
  ...
  const scheduleNext = () => {
    ...
    hourlyTimer = setTimeout(() => {
      runAutoEscalation({ trigger: 'scheduled' }).catch((err) => {
...
export function stopHourlyEscalationScheduler() {
  if (hourlyTimer) {
