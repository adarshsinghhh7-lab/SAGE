        ...
        {currentView === 'detail' && !activeComplaint && (
          <div className="max-w-md mx-auto py-16 px-4 text-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#0B0C0F] text-[#E8DFC8] text-xs font-mono font-bold uppercase rounded-lg border border-[#2A2F3E] cursor-pointer shadow-sm hover:bg-[#1E2230] transition-colors"
            >
